#############################################################################
# Makefile for building: dist/Debug/GNU-Linux-x86/ExecutionClient
...
INCPATH       = -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -Inbproject -I../../include -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I. -I.
LINK          = g++
LFLAGS        = -m64
...
QMAKE_TARGET  = ExecutionClient
DESTDIR       = dist/Debug/GNU-Linux-x86/#avoid trailing-slash linebreak
TARGET        = dist/Debug/GNU-Linux-x86/ExecutionClient
...
dist: 
	@test -d build/Debug/GNU-Linux-x86/ExecutionClient1.0.0 || mkdir -p build/Debug/GNU-Linux-x86/ExecutionClient1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/ExecutionClient1.0.0/ && $(COPY_FILE) --parents ExecutionClient.h build/Debug/GNU-Linux-x86/ExecutionClient1.0.0/ && $(COPY_FILE) --parents main.cpp build/Debug/GNU-Linux-x86/ExecutionClient1.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/ExecutionClient1.0.0` && $(TAR) ExecutionClient1.0.0.tar ExecutionClient1.0.0 && $(COMPRESS) ExecutionClient1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/ExecutionClient1.0.0`/ExecutionClient1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/ExecutionClient1.0.0
