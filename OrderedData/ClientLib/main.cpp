...
//    QCoreApplication a(argc, argv);
    ...
    try{
        ...
        qDebug() << "INSERT:" << client.put("testInsert1", "testValue");
        qDebug() << "INSERT:" << client.put("testInsert2", "testValue");
        qDebug() << "INSERT:" << client.put("testInsert3", "testValue");
        qDebug() << "INSERT:" << client.put("testInsert4", "testValue");
